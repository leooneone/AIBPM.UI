...
const constantRoutes = [
...

  {
    path: '/jsxPreview',
    name: 'jsxPreview',
    component: () => import( "@/views/bpm/jsx.vue" ),
    meta: {
      keepAlive: false
    }
  }
  ,
  {
    path: '/instance',
    name: 'instance',
    component: () => import( "@/views/bpm/instance.vue" ),
    meta: {
      keepAlive: false
    }
  }
  ,
  {
    path: '/workflow',
    name: 'workflow',
    component: () => import( "@/views/bpm/workflow.vue" ),
    meta: {
      keepAlive: false
    }
  }
  , {
    path: '/detail',
    name: 'detail',
    component: () => import( "@/views/bpm/instance/detail.vue" ),
    meta: {
      keepAlive: false
    }
  }
  ,
  {
    path: '/workitem',
    name: 'workitem',
    component: () => import( "@/views/bpm/workItem.vue" ),
    meta: {
      keepAlive: false
    }
  }
  ,
  {
    path: '/test',
    name: 'test',
    component: () => import( "@/views/bpm/test.vue" ),
    meta: {
      keepAlive: false
    }
  }
  ,
  {
    path: '/bpm',
    name: 'bpm',
    component: () => import( "@/views/bpm/template.vue" ),
    meta: {
      keepAlive: false
    }
  }
...
function toLogin(to, next) {
  ...
  if (defaultSettings.is4) {
    if (to.path === '/callback' || to.path === '/refresh'||to.path==='/jsxPreview'||to.path==='/instance') {
      next()
    } else {
      login()
    }
