      ...
      <div class="add-node-btn">
        <el-popover placement="right" trigger="click" width="300">
          <div class="condition-box">
            ...
            <div>
              <div class="condition-icon" onClick={this.eventLancher.bind(ctx, "appendBranch", data, isBranch,false)}>
                <i class="iconfont iconcondition"></i>
              </div>
              条件流转
            </div>
            <div>
              <div class="condition-icon" onClick={this.eventLancher.bind(ctx, "appendBranch", data, isBranch,true)}>
                <i class="iconfont iconcondition"></i>
              </div>
              条件分支
            </div>
