  ...
  <div class="setting-container">
    <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="100px"
      ...
      <el-form-item label="选择分组" prop="groupId">
        <el-select v-model="formData.groupId" placeholder="请选择选择分组" clearable :style="{width: '100%'}">
      ...
      <el-form-item label="审批说明" prop="remark">
        <el-input v-model="formData.remark" type="textarea" placeholder="请输入审批说明" :maxlength="100"
